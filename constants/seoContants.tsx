...
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://Erkotron.digital"; // Update with actual URL
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "Erkotron Systems Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "Erkotron Systems",
  ...
  home: {
    ...
    description:
      "Innovate and grow with Erkotron. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your Erkotron client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "Erkotron dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Erkotron Systems and access premium tech resources.",
    keywords: [
      "Get started with Erkotron",
      "Project onboarding",
      "Digital partnership",
    ],
  },
